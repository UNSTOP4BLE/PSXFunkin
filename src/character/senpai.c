...
static const Animation char_senpai_anim[CharAnim_Max] = {
    {2, (const uint8_t[]){ 0,  1,  2,  3,  4,  4,  4,  0,  1,  2,  3,  4,  4, ASCR_BACK, 1}}, //CharAnim_Idle
...
void Char_Senpai_SetFrame(void *user, uint8_t frame)
{
...
void Char_Senpai_SetAnim(Character *character, uint8_t anim)
{
    //Set animation
